<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Customer_orderTrace.aspx.cs" Inherits="XYZ.Customer_orderTrace" %>
      ...
      <!-- ################################################################################################ -->
        <form runat="server">
                         ...
                         <div class="row">
                             <div class="col-sm-6">
                                    <div class="card">
                                        <h5 class="card-header">Your ID</h5>
                                        <div class="card-body">
                                         ...
                                         <label  class="col-form-label"><b>' P ' = Pending Order/s </b></label><br/>
                                         <label  class="col-form-label"><b>' F ' = Finished Order/s </b></label>
                                                    <p class="text-right">
